...
class Gaussian_second_lens:
    def __init__(self, w0, lambdaL, defocusing_range, Denting, N):
        ...
        self.w0 = self.diffraction_limit()
    ...
    def Rayleigh_length(self): 
        ...
        print('Rayleigh length fundamental: ' , Ry, 'for wo', self.w0_fundamental )
        return Ry
    ...
    def calulate_beam_waist_single_value(self, index):
        #print(self.w0, 'w0 initial', self.q, 'q-vector')
    ...
    def create_v_array_z_dependent_focal_lens(self):
            ...
            # initialisation of f-array (beam waist depedent in class initialisation)
    ...
    def resulting_beam_divergence(self):
        ...
        plt.ylabel='[rad]'
        plt.legend()
        plt.savefig("Theta_50nm_caseI" +".png",  bbox_inches="tight", dpi = 1000)
...
Test = Gaussian_second_lens(0.014, 0.0008, 5, 0.00005, 1)
#Test.beamwaist_of_z()
...
Test2 = Gaussian_second_lens(0.014, 0.0008, 5, 0.00005, 25)
#Test.q_harmonic()
Test2.calculate_new_beamwaist()
Test2.resulting_beam_divergence()
#Test2.beam_waist_of_z_harmonic()

Test3 = Gaussian_second_lens(0.014, 0.0008, 5, 0.00005, 2)
...
Test3.resulting_divergence_over_N(0.9)
Test3.resulting_divergence_over_N(-1.1)
...
plt.savefig("div_over_N_50nm_caseI" +".png",  bbox_inches="tight", dpi = 1000)
#Test3.resulting_divergence_over_N(2.5)
